    ...
    public partial class FrmSales : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (txtProductSalesAmount.Text.Trim() == "")
                MessageBox.Show("Please fill in amount of stocks to buy");           
            else
            {
                if (!isUpdate)
                {
                    if (detail.ProductID == 0)
                        ...
                        MessageBox.Show("There is not enough stocks to purchase");
                    else
                    {
                        ...
                        {
                            MessageBox.Show("Sales went through");
                            bll = new SalesBLL();
                            dto = bll.Select();
                            gridProduct.DataSource = dto.Products;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (temp < Convert.ToInt32(txtProductSalesAmount.Text))
                            MessageBox.Show("There is not enough stock of product to buy");
                        else
                        {
                            detail.SalesAmount = Convert.ToInt32(txtProductSalesAmount.Text);
