...
namespace StockTracking
{
    public partial class FrmSalesList : Form
    {
        ...
        private void txtRevenue_KeyPress(object sender, KeyPressEventArgs e)
        {
            e.Handled = General.isNumber(e);
        }
        ...
        private void FrmSalesList_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[6].HeaderText = "Stocks Sold";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (txtPrice.Text.Trim() != "")
            {
                if (rbPriceEquals.Checked)
                    ...
                    MessageBox.Show("Please select a criterion for price");
            }
            if (txtSalesAmount.Text.Trim() != "")
            {
                if (rbSalesEqual.Checked)
                    ...
                    MessageBox.Show("Please select a criterion for amount sold");
            }
            if(chDate.Checked)
